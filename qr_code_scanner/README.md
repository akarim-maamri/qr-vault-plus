...
- **شبكات WiFi** — دعم شبكات الـ WiFi (اسم الشبكة، كلمة المرور، ونوع الحماية: WPA/WEP/None).
...
- **رصد أي متطفل** — التقاط صورة سيلفي بعد 3 محاولات خاطئة متتالية لإدخال رمز PIN..
...
** لااتنسَ إضافة نجمة للمستودع إذا أعجبك التطبيق **
