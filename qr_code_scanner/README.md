...
**+QR Vault** هو تطبيق أندرويد احترافي يجمع بين مسح رموز QR وإنشائها وحفظها بأمان داخل خزنة مشفرة محمية برمز PIN والبيومتريا. مصمم بواجهة سايبربانك مميزة تدعم اللغتين العربية والإنجليزية.
...
- نسخ ومشاركة النتائج بسهولة

### 🎨 إنشاء رموز QR مخصصة
- **روابط URL** — مواقع ويب وروابط مباشرة
- **جهات الاتصال (vCard)** — بطاقة اتصال كاملة
- **شبكات WiFi** — مشاركة كلمة المرور بنقرة واحدة
- **رسائل نصية SMS** — إرسال رسائل جاهزة
- **بريد إلكتروني** — رسائل إيميل مُعدَّة مسبقاً
- **مواقع GPS** — إحداثيات جغرافية
- **تطبيقات WhatsApp & Telegram** — روابط مباشرة
- **دفع PayPal** — طلبات الدفع الفوري
- **تخصيص كامل** — ألوان، حجم، صيغة PNG/SVG

### 🔐 خزنة الأمان الفائقة
- **تشفير AES-256** لحماية البيانات
- قفل برمز **PIN رباعي الأرقام**
- دعم **البصمة والتعرف على الوجه**
- **رمز استرداد احتياطي** في حالة نسيان PIN
- **كاميرا تجسس** — تلتقط صورة عند محاولة الاختراق
